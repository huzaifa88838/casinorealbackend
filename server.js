 ...
 */
require('dotenv').config();  // <-- dotenv ko yahan load karo
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://huzaifa:huzaifa56567@cluster0.owmq7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
